            ...
            <div class="modal-body">
                <form method="POST" action="{{ route('admin.archive') }}">
                    ...
                    <table class="table" id="example">
                        ...
                        <tbody>
                            @foreach ($archivedAdmins as $archivedAdmin)
                                <tr>
                                    <th scope="row">
                                        <input type="checkbox" name="selected_admin[]"
                                            value="{{ $archivedAdmin->id }}">
                                    </th>
                                    <td>{{ $archivedAdmin->id }}</td>
                                    <td>{{ $archivedAdmin->fname }}</td>
                                    <td>{{ $archivedAdmin->lname }}</td>
                                </tr>
                            @endforeach
